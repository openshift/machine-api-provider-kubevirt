...
ifeq ($(NO_DOCKER), 1)
  ...
  DOCKER_CMD := docker run --rm -e CGO_ENABLED=1 -v "$(PWD)":/go/src/github.com/openshift/cluster-api-provider-kubevirt:Z -w /go/src/github.com/openshift/cluster-api-provider-kubevirt openshift/origin-release:golang-1.14
